...
/**
 *  @brief Cr data Service UUID value
 */
#define BT_UUID_CRS_VAL 0x1870
/**
 *  @brief Cr Service
 */
#define BT_UUID_CRS \
	BT_UUID_DECLARE_16(BT_UUID_CRS_VAL)
...
/**
 *  @brief CRS Characteristic Measurement Interval UUID value
 */
#define BT_UUID_CRS_MEASUREMENT_VAL 0x2c50
/**
 *  @brief CRS Characteristic Measurement Interval
 */
#define BT_UUID_CRS_MEASUREMENT \
	BT_UUID_DECLARE_16(BT_UUID_CRS_MEASUREMENT_VAL)

#define BT_UUID_CRS_BODY_SENSOR_VAL 0x2c51
/**
 *  @brief CRS Characteristic Control Point
 */
#define BT_UUID_CRS_BODY_SENSOR \
	BT_UUID_DECLARE_16(BT_UUID_CRS_BODY_SENSOR_VAL)
/**
 *  @brief CRS Characteristic Control Point UUID value
 */
#define BT_UUID_CRS_CONTROL_POINT_VAL 0x2c52
/**
 *  @brief CRS Characteristic Control Point
 */
#define BT_UUID_CRS_CONTROL_POINT \
	BT_UUID_DECLARE_16(BT_UUID_CRS_CONTROL_POINT_VAL)	
